      ...
      <div className="bg-card rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden">
        ...
        <div className="relative px-6 pt-7 pb-5 border-b border-border">
          ...
          <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
            {total} personally curated spots — {wineries} wineries, {restaurants} restaurants, {farmstands} farm stands, and {artisans} artisan makers (cideries, distilleries, olive oils, chocolates) — verified by a professional chef who actually goes to all of them.
          </p>
        </div>
        ...
        <div className="px-6 pb-2">
          <div className="bg-muted/50 rounded-xl px-4 py-3 space-y-1.5">
            ...
            <p className="text-xs text-muted-foreground leading-snug">
              <span className="font-medium text-foreground">Ask Foothills Chef</span> (bottom right) — an AI that knows this map inside out.
            </p>
            <p className="text-xs text-muted-foreground leading-snug">
