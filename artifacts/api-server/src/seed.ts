...
const SEED_DATA = [
  ...
  { name: "diVittorio Winery", city: "Camino", note: "A family winery on Carson Road continuing a tradition that began when the diVittorio family immigrated from Italy in 1904. The tasting room carries both traditional estate wines and something genuinely unusual: wines made from nectarines and plums harvested from the property's own orchard, alongside Portuguese Port and Orange Muscat. Open Fri–Sun 11am–5pm. The most distinctive wine portfolio on the Carson Road corridor.", category: "winery", lat: 38.7091, lng: -120.6552, website: "https://divittoriowinery.com" },
  ...
  { name: "24 Carrot Farm", city: "Placerville", note: "CERTIFIED ORGANIC for all crops — apples, pumpkins, and honey from farm hives on Jacquier Road in the Apple Hill area. Chemical-free operation, formerly Willow Pond Farm. A conscientious choice when you want to buy produce from a farm operating with serious agricultural values. Daily 10am–5pm, seasonal.", category: "farmstand", lat: 38.7133, lng: -120.6393, website: "https://www.applebill.com" },
  ...
  { name: "Amore Mio Italian Bistro", city: "Placerville", note: "Italian fusion with a devoted local following at 451 Main St. The Piemontese Bagna Cauda flatbread — crispy outside, doughy inside — is described by regulars as the best flatbread in El Dorado County, without hyperbole. Earns word-of-mouth the old-fashioned way: by being genuinely good and not overextending.", category: "restaurant", lat: 38.7294, lng: -120.7982, website: "https://amoremioitalianbistro.com" },
  { name: "Enchanted Forest Dining Experience", city: "Placerville", note: "Reservation-only, immersive European dining experience — four-course fondue dinners in a themed setting. Best suited for a slow, celebratory evening. Genuinely unusual and memorable. Book via OpenTable; this is the kind of dinner that works better when you don't know exactly what to expect going in.", category: "restaurant", lat: 38.7289, lng: -120.7972, website: "https://www.exploretock.com" },
  ...
  { name: "Pure Gold Vine Bistro", city: "Somerset", note: "A farm-to-fork bistro in the heart of the Fair Play wine country on Grizzly Flat Road at Mt. Aukum — Executive Chef Lisa's kitchen sources fresh, seasonal produce locally and pours many Sierra Foothill wines. Open Thu–Sun (dinner nightly, brunch Sat–Sun). The best option for a sit-down meal during a day of Fair Play AVA tasting room visits, without driving back down to Placerville.", category: "restaurant", lat: 38.5430, lng: -120.7060, website: "https://www.puregoldvinebistro.com" },
  { name: "Annabelle's Chocolate Lounge", city: "El Dorado", note: "Award-winning artisan chocolate shop and wine bar on Pleasant Valley Road — the same road that leads to Narrow Gate Vineyards. Seventy-five varieties of chocolate, all made without waxes or preservatives. The wine-and-chocolate flight pairs four El Dorado and Amador County wines with chocolates and tasting notes. Open Mon–Sat 11am–6pm. The kind of stop that earns a cult following for doing one thing very well.", category: "producer", lat: 38.6710, lng: -120.8220, website: "https://www.annabelleschocolate.com" },
];
