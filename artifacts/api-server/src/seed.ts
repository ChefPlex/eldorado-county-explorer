...
const SEED_DATA = [
  ...
  { name: "Moonraker Brewing Company", city: "Cameron Park", note: "Award-winning craft brewery at 3501 La Crescenta Dr in Cameron Park — one of the most decorated small breweries in the Sierra Foothills region. Known for hazy IPAs and barrel-aged ales with serious craft discipline. Taproom with rotating taps and a welcoming neighborhood vibe. A genuine find in the El Dorado County corridor, worth the stop coming or going on Highway 50.", category: "artisan", lat: 38.6795, lng: -120.9912, website: "https://www.moonrakerbrewing.com" },

  // ── RESTAURANTS: ADDITIONAL ───────────────────────────────────────────────
  { name: "Heyday Café", city: "Placerville", note: "Beloved Placerville institution at 325 Main St — counter service with a commitment to freshness and an extensive local wine list that turns lunch into an afternoon. Upscale handcrafted pizzas (truffle chicken, butternut squash and bacon) make this a daytime winemaker hangout. The kind of place that earns loyalty by being consistently good rather than trendy.", category: "restaurant", lat: 38.7297, lng: -120.7979 },
  { name: "Sienna Restaurant", city: "El Dorado Hills", note: "Refined yet approachable neighborhood restaurant in El Dorado Hills — fireplace in the dining room, globe-spanning appetizers like kung pao calamari and macadamia nut-crusted Brie. Sunday and Monday three-course wine dinners are a standout value. The kind of place locals take out-of-town guests to impress without going formal.", category: "restaurant", lat: 38.6789, lng: -121.0744 },
  { name: "Eldo Chop House", city: "El Dorado Hills", note: "Cozy yet sophisticated El Dorado Hills chophouse with fresh seafood, serious burgers, and succulent steaks sourced with quality and paired with expertly crafted cocktails at a stylish bar. A newer gem that quickly became a local favorite. The combination of honest steakhouse execution and a polished room makes it one of the better upscale options in the county.", category: "restaurant", lat: 38.6800, lng: -121.0742, website: "https://www.eldochophouse.com" },
  { name: "Fourk", city: "El Dorado Hills", note: "One seating per evening. Four courses. Chef-driven menu changes the first Wednesday of every month — genuinely seasonal rather than performatively so. Doors open at 5:30 PM for a relaxed happy hour with discounted wine by the glass. As wine-country in spirit as anything you'll find in Napa, at a fraction of the pretension. Book ahead.", category: "restaurant", lat: 38.6610, lng: -121.0560, website: "https://www.fourkrestaurant.com" },
  { name: "Allez! Bistro", city: "El Dorado Hills", note: "French-inspired bistro with a foothills twist, beloved by the winemaking crowd for its casual elegance and honest technique. Standout dishes like Prawns Martiniquais and Seafood Crêpes pair beautifully with local Grenache Noir. The kind of European bistro cooking that rarely shows up in foothill wine country — an earned reputation among winemakers who know where to eat.", category: "restaurant", lat: 38.7005, lng: -121.0280 },
  { name: "Enchanted Forest Dining Experience", city: "Placerville", note: "European-inspired dining with enchanted decor — Irish dishes like Cornish Pasty Pie and Guinness-Glazed Salmon alongside sweet and savory crêpes and fondue. A fun, celebration-friendly spot that brings an unexpected European sensibility to the Sierra Foothills. The kind of place that earns return visits from locals looking for something different from the wine-country standard.", category: "restaurant", lat: 38.7200, lng: -120.7950, website: "https://enchantedforestdining.com" },
  { name: "Vacanza Romana", city: "El Dorado Hills", note: "True Italian gem in El Dorado Hills with hand-made pasta using real Italian flour and fresh ingredients — among the best Italian cooking in El Dorado County. Extensive California wine list with by-the-glass pours that other restaurants only sell by the bottle. The pasta program alone is worth the drive from anywhere in the county.", category: "restaurant", lat: 38.6795, lng: -121.0748 },
  { name: "Placerville Public House", city: "Placerville", note: "Family-owned pub and restaurant in Placerville, in business since 2016 and a reliable community staple. Known for pub nachos, a pulled pork sandwich worth returning for, and gourmet pizzas. Popular with families and locals who want a good meal without formality. Creative drinks and a welcoming vibe — exactly what a neighborhood public house should be.", category: "restaurant", lat: 38.7290, lng: -120.7970 },
  { name: "Geartooth Alewerks", city: "Diamond Springs", note: "Craft beer haven south of Placerville with hearty food and a laid-back local taproom feel. The Chicken Sando with house-made crispy fries pairs perfectly with their IPA — a combination that has built a loyal following among the vineyard and farm crowd. Very popular with the working agricultural community. A genuine neighborhood taproom that happens to make excellent beer.", category: "restaurant", lat: 38.6854, lng: -120.8620, website: "https://www.geartoothalewerks.com" },
  { name: "Powell's Steamer Co. & Pub", city: "Placerville", note: "A Placerville institution established in 1943 — locally sourced food, wine, and beer with a full bar and that quintessential Gold Country pub vibe. Voted #1 for steaks and cocktails in the area. Solid, honest cooking with roots going back to the post-war era. One of the few places in El Dorado County where the history of the room adds to the experience of the meal.", category: "restaurant", lat: 38.7295, lng: -120.7975, website: "https://www.powellssteamer.com" },
  { name: "Pachamama Coffee", city: "Placerville", note: "The undisputed top pick for serious coffee lovers in the region. A fully farmer-owned, seed-to-cup coffee cooperative with farmer-owners in Peru, Nicaragua, Guatemala, Mexico, and Ethiopia — they roast their own beans right in El Dorado Hills. The café stands out with a unique interior, a lush courtyard adorned with flowing fountains, and small-batch roasted coffee that customers rave about for its distinct and delicious taste. The secluded courtyard is the real treasure — perfect for a self-care caffeine moment. Try the honeybear oat milk latte or keep an eye out for their seasonal maple brulée latte, which they even scorch the top of.", category: "restaurant", lat: 38.7280, lng: -120.7981, website: "https://pachamamacoffee.com" },
  { name: "Zia's Café", city: "El Dorado Hills", note: "The go-to for El Dorado Hills locals. A little bit of Italy in El Dorado Hills — from the homemade pastries and gelato to the authentic espresso drinks, quality spans the entire menu. Their Town Center location is charming and cozy, still offering plenty of room for those looking to read a book or work on a laptop. Try the Caffe Miele Macchiato — espresso sweetened with Spanish lavender honey.", category: "restaurant", lat: 38.6852, lng: -121.0725 },
];
