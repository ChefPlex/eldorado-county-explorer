...
const SEED_DATA = [
  ...
  { name: "El Dorado Orchards", city: "Camino", note: "A classic Apple Hill orchard on North Canyon Road — u-pick apples, fresh-pressed cider, and an on-site farm store carrying fruit, honey, and jams. 2881 N. Canyon Road, Camino. The orchard runs from Galas in late August through the full November crop. Quieter than the Carson Road farms and worth knowing for that reason alone.", category: "farmstand", lat: 38.7173, lng: -120.6292, website: "https://www.eldoradoorchards.com" },
  ...
  { name: "Smith Flat House", city: "Placerville", note: "Wine bar and event venue on Smith Flat Road, a few minutes east of downtown Placerville. The focus is on local and regional wines — El Dorado County pours alongside a thoughtful small menu. Live music on weekends, private event space, and a patio that earns a visit in good weather. Voted Best Brunch 2024 in the county. 2021 Smith Flat Rd.", category: "restaurant", lat: 38.7247, lng: -120.7744, website: "https://smithflathouse.com" },
